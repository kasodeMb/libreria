...
if($_POST['agendar'])
{
	...
	if(!empty($_POST['nombre']) ||  !empty($_POST['correo']))
	{
		...
		mysqli_query($conexion, "INSERT INTO libros(nombre, correo) VALUES ('$nombre','$correo')");
        ...
        <table width="106%" height="378" border="0">
          ...
          <tr>
            <td height="334" colspan="3" valign="top"><div align="center"><em><span style="color:red;">
              ...
              <div id="apDiv4"><a href="logout.php"><img src="IMAG/exit.png" width="100" height="70" /></a>  <a href="Index - Menu.html"> <img src="IMAG/menu.png" width="91" height="69" /></a></div>
            </td>
          </tr>
        </table>
      </div>
